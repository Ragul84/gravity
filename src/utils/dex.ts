...
// export async function buyJetton(wallet: WalletContractV4, amount: string | number, jettonAddress: string, keyPair: KeyPair) {
...
// export async function sellJetton(wallet: WalletContractV4, amount: string | number, jettonAddress: string, keyPair: KeyPair) {
//   const contract = client.open(wallet)
//   const txArgs = {
//     userWalletAddress: wallet.address.toString(), // ! replace with your address
